...
```json
{
  "$schema": "https://raw.githubusercontent.com/DocCLab/VersionedDocC/0.1.1/Schema/VersionedDocC.schema.json",
  "schemaVersion": 1,
...
- uses: DocCLab/VersionedDocC@0.1.1
  with:
    config: .vdc.json
...
jobs:
  documentation:
    uses: DocCLab/VersionedDocC/.github/workflows/pages.yml@0.1.1
    with:
      config: .vdc.json
